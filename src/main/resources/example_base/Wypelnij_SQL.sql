...
VALUES (1, 'A', 1, 'test@test.pl', 'admin', 'Przemek', 'admin', '111111111', 'Przyslo');

INSERT INTO RENTIT.ACCOUNT (ID, ACCOUNT_FUNCTION, ACTIVE, EMAIL, LOGIN, NAME, PASSWORD, PHONE, SURNAME) 
VALUES (2, 'K', 1, 'kierownik@kierownik.pl', 'kierownik', 'Jan', 'kierownik', '222222222', 'Tomaszak');

INSERT INTO RENTIT.ACCOUNT (ID, ACCOUNT_FUNCTION, ACTIVE, EMAIL, LOGIN, NAME, PASSWORD, PHONE, SURNAME) 
VALUES (3, 'P', 1, 'pracownik@pracownik.pl', 'pracownik', 'Zenon', 'pracownik', '333333333', 'Pasztet');
...
INSERT INTO RENTIT.RESERV (ID, DESCRIPTION, RESERVATION_END, RESERVATION_MADE_DATE, RESERVATION_START, ACCOUNT_ID, RESERV_STATUS_ID) 
...
INSERT INTO RENTIT.EQUIPMENT (ID, NAME, RENT_PERMISSION, TYPE, LICENSE_TYPE_ID, RESERV_ID, USE_PLACE_ID) 
VALUES (1, 'Komputer', 't', 'stacjonarny',1, 1, 1);

INSERT INTO RENTIT.EQUIPMENT (ID, NAME, RENT_PERMISSION, TYPE, LICENSE_TYPE_ID, RESERV_ID, USE_PLACE_ID) 
VALUES (2, 'Laptop1', 't', 'przenosny', 2, 2, 2);

INSERT INTO RENTIT.EQUIPMENT (ID, NAME, RENT_PERMISSION, TYPE, LICENSE_TYPE_ID, RESERV_ID, USE_PLACE_ID) 
VALUES (3, 'Rzutnik', 'n', 'stacjonarny', 2, 2, 3);
